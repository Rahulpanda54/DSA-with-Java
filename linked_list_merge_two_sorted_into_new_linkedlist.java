public class linked_list_merge_two_sorted_into_new_linkedlist{
    ...
    public static void main(String[] args) {
        linked_list_merge_two_sorted_into_new_linkedlist obj = new linked_list_merge_two_sorted_into_new_linkedlist();
         listNode a = new listNode(10);
         a.next = new listNode(40);
